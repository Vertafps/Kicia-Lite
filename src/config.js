...
module.exports = {
  ...
  GEMINI_SCAM_FAILURE_COOLDOWN_MS: 2 * 60 * 1000,
  ENABLE_TOXICITY_SHADOW_MODEL: optionalBoolean("ENABLE_TOXICITY_SHADOW_MODEL", false),
  TOXICITY_MODEL_ID: optional("TOXICITY_MODEL_ID") || "Xenova/toxic-bert",
  TOXICITY_MODEL_TIMEOUT_MS: Number(optional("TOXICITY_MODEL_TIMEOUT_MS") || 2_500),
  ENABLE_SCAM_EMBED_CLASSIFIER: optionalBoolean("ENABLE_SCAM_EMBED_CLASSIFIER", true),
  SCAM_EMBED_MODEL_ID: optional("SCAM_EMBED_MODEL_ID") || "Xenova/all-MiniLM-L6-v2",
  SCAM_EMBED_TIMEOUT_MS: Number(optional("SCAM_EMBED_TIMEOUT_MS") || 1_500),
  SCAM_EMBED_CACHE_PATH: optional("SCAM_EMBED_CACHE_PATH") || "data/scam-embeddings-cache.json",
  SCAM_EMBED_TOP_K: Number(optional("SCAM_EMBED_TOP_K") || 7),
