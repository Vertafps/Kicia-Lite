...
const SELLING_PUBLIC_REPLIES = [
  "Trading? what is that, bro discovered capitalism and got patched",
  "He thought the deal would work. It remained a thought.",
  "bro opened marketplace mode in the official Kicia server",
  "checkout lane closed, cashier left, trade deleted",
  "this deal walked in wearing a fake mustache and fake confidence",
  "Kicia customs seized the suspicious deal package at spawn",
  "bro is not Elon Musk, this trade pitch is not going public",
  "trade offer declined by everyone with a working frontal lobe",
  "that scam pitch had temu villain energy",
  "private-deal energy detected, chat started coughing",
  "the scam scanner hit a 360 and landed on delete",
  "bro tried to turn premium oxygen into a trade deal with express shipping",
  "marketplace cosplay detected, costume removed",
  "that deal failed the smell test, the math test, and the vibe check",
  "deal denied, bro got folded by a regex with standards",
  "the trade cart lost a wheel and hit the delete button",
  "bro brought a checkout counter to Kicia like we asked",
  "nice marketplace business plan, the investors are imaginary",
  "that trade idea was cooked in a microwave with no plate",
  "the deal bargain bin has been unplugged from reality",
  "this is not a startup pitch meeting, bro is pitching vapor",
  "bro said trust me and the scam scanner started laughing",
  "trade_transaction.exe crashed from second-hand embarrassment",
  "the suspicious little deal invoice got sent to the shadow realm",
  "sir this is the official Kicia server, not Deal or No Deal"
];
const PROHIBITED_SALE_PUBLIC_REPLIES = [
  "that prohibited sale got dropkicked into policy jail",
  "prohibited sale removed, side quest failed instantly",
  "bro tried to list the unlistable and got speedran",
  "marketplace lane closed for crimes against judgment",
  "that sale left the chat before it became a documentary",
  "policy guard saw that deal and clocked in early",
  "that catalog item got rejected at character select",
  "nope, that prohibited shop got nuked from orbit"
];
