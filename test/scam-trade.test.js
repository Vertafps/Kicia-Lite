...
const MUST_NOT_FLAG_CASES = [
  ...
  // Kicia/v3/configs/etc. but is NOT scam intent. Verified end-to-end against
  // both classifiers; each must classify as `ignore` on scam-trade.
  ...
  // H. Edge cases / borderline (must still classify as ignore on scam)
